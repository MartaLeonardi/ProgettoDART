...
public class PAmm extends JFrame {
	...
	public PAmm() {
		...
		AssumiImp assumiImp = new AssumiImp();
		LicenziaImp licenziaImp = new LicenziaImp();
		VisualizzaSchedaImp visualizzaSchedaImp = new VisualizzaSchedaImp();
		VisTurni visTurni = new VisTurni();
		VisServizi visServizi = new VisServizi();
		PermessoImp permessoImp = new PermessoImp();
		VisStipendi visStipendi = new VisStipendi();
