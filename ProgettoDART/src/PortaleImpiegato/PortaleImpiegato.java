...
public class PortaleImpiegato extends JFrame {
	...
	public PortaleImpiegato() {
		...
		FirmaIngresso firmaIng = new FirmaIngresso();
		VisualizzaStipendio visStipendio = new VisualizzaStipendio();
		VisualizzaOrario visOrario = new VisualizzaOrario();
		RichiediPermesso richiediPerm = new RichiediPermesso();
		...
		contentPane.add(modificaAccount, "ModificaAccount");
