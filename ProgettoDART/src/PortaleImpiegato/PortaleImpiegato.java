...
public class PortaleImpiegato extends JFrame {
	...
	public PortaleImpiegato() {
		...
		//-------------------------------------------------------------------------------------------------EVENTO FIRMA INGRESSO > FirmaIngresso.java
		...
		//-------------------------------------------------------------------------------------------------EVENTO VISUALIZZA STIPENDIO> VisualizzaStipendio.java
		...
		//-------------------------------------------------------------------------------------------------EVENTO VISUALIZZA ORARIO > VisualizzaOrario.java
		...
		//-------------------------------------------------------------------------------------------------EVENTO RICHIEDI PERMESSO > RichiediPermesso.java
		...
		//-------------------------------------------------------------------------------------------------EVENTO RICHIEDI SCIOPERO > RichiediSciopero.java
		...
		//-------------------------------------------------------------------------------------------------EVENTO RICHIEDI FERIE > RichiediFerie.java
